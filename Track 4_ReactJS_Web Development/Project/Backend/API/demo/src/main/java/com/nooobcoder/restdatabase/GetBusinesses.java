...
@WebServlet(
        name = "GetBusinesses", value = "/getbusinesses",
        initParams = {
...
public class GetBusinesses extends HttpServlet {
...
//            System.out.println(initParamName + " initParamName");
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getMethod().equals("POST")) {
            ...
            try {
                List<Map<String, Object>> rows = DBConnection.executeQuery("SELECT * FROM business;");
