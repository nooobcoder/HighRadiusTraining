...
def predict(nulldata):
    ...
    # if : nulldata['cust_number'] = nulldata['cust_number'].str.replace('CCCA',"1").str.replace('CCU',
    # "2").str.replace('CC',"3").astype(int)
    nulldata['cust_number'] = nulldata['cust_number'].replace('CCCA02', "1").replace(['CCU001', 'CCU013', 'CCU002'],
                                                                                     "2").replace(['CC3411', 'CC6000'],
                                                                                                  "3").astype(int)
